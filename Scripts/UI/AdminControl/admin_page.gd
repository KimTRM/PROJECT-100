...
var QUIZ_EDITOR = load("res://Scenes/UI/AdminControl/QuizEditor/QuizEditor.tscn")
var quiz

const ACCOUNTS_VIEWER = preload("res://Scenes/UI/AdminControl/UserAccounts/AccountsViewer.tscn")
var acc
